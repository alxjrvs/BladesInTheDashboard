...
ActiveRecord::Schema[7.0].define(version: 20_230_701_024_454) do
  ...
  create_table 'player_characters', force: :cascade do |t|
    ...
    t.jsonb 'items',
            default: { 'a_blade_or_two' => { 'cost' => 1, 'name' => 'A Blade or Two', 'points' => 0 },
                       'a_large_weapon' => { 'cost' => 1, 'name' => 'A Large Weapon', 'points' => 0 } }
